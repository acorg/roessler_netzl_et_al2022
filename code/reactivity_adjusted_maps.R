...
full_map_p1_adj <- optimizeAgReactivity(full_map, fixed_ag_reactivities = c(0, 0, 0, -1, 0, 0, 0, 0, 0), reoptimize = F)
...
single_map_p1_adj <- optimizeAgReactivity(map_single, fixed_ag_reactivities = c(0, 0, 0, -1, 0, 0, 0, 0, 0), reoptimize = F)
