...
png("som/bootstrapping/bootstrapping-antigens.png", width = 10, height = 4, units = 'in', res=300, pointsize = 18)
layout(matrix(c(1:8), ncol = 4))
...
# run below if you saved map above
png("som/bootstrapping/bootstrapping-antigens.png", width = 10, height = 4, units = 'in', res=300, pointsize = 18)
